package com.shrimp.ext.audio
{
	...
	public class SoundTween
	{
		...
		protected var _sound:SoundItem;
		...
		public function SoundTween(si:SoundItem, endVolume:Number, duration:Number, isMasterFade:Boolean = false)
		{
			if(si)
			{
				sound = si;
		...
		public function set sound(value:SoundItem):void
		{
			_sound = value;
